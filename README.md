...
Plataforma web para crear, desplegar y administrar microservicios dinamicamente usando contenedores Docker. Cada microservicio se ejecuta en su propio contenedor, se expone via HTTP y retorna respuestas en formato JSON.
...
- **Backend** - API REST Node.js/Express en el puerto `4000`. Genera Dockerfiles, construye imagenes y gestiona contenedores con `dockerode`.
- **Microservicios** - Contenedores independientes creados dinamicamente, expuestos desde el puerto `9000` en adelante.

## Requisitos previos
1. Docker instalado y en ejecucion
2. Docker Compose
...
El codigo pegado en el dashboard debe ser un servidor HTTP que escuche en el puerto 8080. Si no lo hace, el contenedor arranca y se cae de inmediato. Los siguientes ejemplos estan listos para usarse.
